(function attachWaterStatusCalc(global) {
  ...
  const CONTROL_VALUES = [131406, 25697, 24574, 65216, 18753, 26573, 70822, 21154, 20993, 51232, 36737, 26950, 31227];
  const REVIEW_SMALL_PLANT_TOTAL_COLS = [30, 31, 32, 33, 34, 35, 37, 38, 39];
